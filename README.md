# Проект по автоматизации тестирования sbergraduate.ru
<a href="https://sbergraduate.ru/"><img width="50%" title="Sbergraduate" src="images/logo/sbergraduate-logo.png"></a>
...
- Проверка работы страницы Рассылки (c PageObjects)
- Проверка работы станицы 'События' (c PageObjects)
- Проверка наличия Title на странице (работоспособности сайта)
- Проверка наличия ошибок в консоли

## :point_up_2: Сборка в Jenkins
### <a target="_blank" href="https://jenkins.autotests.cloud/job/Zoloft-Sbergraduate-Tests/">Сборка в Jenkins</a>
<p align="center">
